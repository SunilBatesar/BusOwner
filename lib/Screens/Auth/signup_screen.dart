            ...
            child: Padding(
                ...
                child: SingleChildScrollView(
                    child: Column(
                      ...
                      styleSheet.appServices.addheight(15),
                      Text(LanguageConst.fullName.tr,
                          style: styleSheet.textTheme.fs14Medium
                              .copyWith(color: styleSheet.colors.mediumgray)),
                      styleSheet.appServices.addheight(10),
                      PrimaryTextfield(
                          ...
                          onsubmitedfun: (p0) {
                            AppUtils.fieldFocusChange(context,
                                _fullNameFocusNode, _passwordFocusNode);
                          }),
                      styleSheet.appServices.addheight(15),
                      Text(
                      ...
                      Obx(() => PrimaryTextfield(
                          ...
                          sufixIcon: _passwordVisible.value
                              ...
                              : Icons.visibility)),
                      styleSheet.appServices.addheight(15),
                      Text(LanguageConst.reTypePassword.tr,
                          style: styleSheet.textTheme.fs14Medium
                              .copyWith(color: styleSheet.colors.mediumgray)),
                      styleSheet.appServices.addheight(10),
                      Obx(() => PrimaryTextfield(
                      ...
                      Row(children: [
                        ...
                        Text(LanguageConst.iAgreeCondition.tr,
